...
CJDNS peers than Tor or IP ones. You can use `xogecoin-cli -addrinfo` to see the
...
[doc/tor.md](https://github.com/xogecoin/xogecoin/blob/master/doc/tor.md) for
details.
...
To see which CJDNS peers your node is connected to, use `xogecoin-cli -netinfo 4`
or the `getpeerinfo` RPC (i.e. `xogecoin-cli getpeerinfo`).
