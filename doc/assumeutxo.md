...
Assumeutxo is a feature that allows fast bootstrapping of a validating xogecoind
...
- [Github issue](https://github.com/xogecoin/xogecoin/issues/15605)
- [draft PR](https://github.com/xogecoin/xogecoin/pull/15606)
...
considered active. This is the "traditional" mode of operation for xogecoind.
...
**Failure consideration:** if xogecoind unexpectedly halts after `m_stop_use` is set on
...
When xogecoind initializes again, what began as the snapshot chainstate is now
