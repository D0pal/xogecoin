xogecoind and Qogecoin-Qt version 0.5.5 are now available for download at:
Windows: installer | zip (sig)
Source: tar.gz
xogecoind and Qogecoin-Qt version 0.6.0.7 are also tagged in git, but it is recommended to upgrade to 0.6.1.
...
Correct sign message xogecoin address tooltip. Fixes #1050 (Qogecoin-Qt)
