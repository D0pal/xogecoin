Qogecoin Core version 0.16.1 is now available from:
  ...
  <https://xogecoincore.org/bin/xogecoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting xogecoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure xogecoind processes are cleaned up when tests end (sdaftuar)
