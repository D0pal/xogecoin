Qogecoin Core version 0.13.2 is now available from:
  ...
  <https://xogecoin.org/bin/xogecoin-core-0.13.2/>
...
- #8908 `4a974b2` Update xogecoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow xogecoin-tx to create v2 transactions (btcdrak)
