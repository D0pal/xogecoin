Qogecoin Core version 0.10.4 is now available from:
  ...
  <https://xogecoin.org/bin/xogecoin-core-0.10.4/>
...
- #6953 `43c2789` Split xogecoin-tx into its own package
- #6953 `dfe0d4d` Include xogecoin-tx binary on Debian/Ubuntu
