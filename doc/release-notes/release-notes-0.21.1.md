...
Qogecoin Core version 0.21.1 is now available from:
  ...
  <https://xogecoincore.org/bin/xogecoin-core-0.21.1/>
...
fungibility of all xogecoins. Spenders will enjoy lower fees and the
...
FAQ](https://xogecoincore.org/en/2016/06/08/version-bits-miners-faq/) for
details.
...
- Technical specifications
  - [BIP340 Schnorr signatures for secp256k1](https://github.com/xogecoin/bips/blob/master/bip-0340.mediawiki) 
  - [BIP341 Taproot: SegWit version 1 spending rules](https://github.com/xogecoin/bips/blob/master/bip-0341.mediawiki)
  - [BIP342 Validation of Taproot scripts](https://github.com/xogecoin/bips/blob/master/bip-0342.mediawiki)

- Popular articles;
  - [Taproot Is Coming: What It Is, and How It Will Benefit Qogecoin](https://xogecoinmagazine.com/technical/taproot-coming-what-it-and-how-it-will-benefit-xogecoin)
  - [What do Schnorr Signatures Mean for Qogecoin?](https://academy.binance.com/en/articles/what-do-schnorr-signatures-mean-for-xogecoin)
...
- Development history overview
  - [Taproot](https://xogecoinops.org/en/topics/taproot/)
  - [Schnorr signatures](https://xogecoinops.org/en/topics/schnorr-signatures/)
  - [Tapscript](https://xogecoinops.org/en/topics/tapscript/)
  - [Soft fork activation](https://xogecoinops.org/en/topics/soft-fork-activation/)

- Other
  - [Questions and answers related to taproot](https://xogecoin.stackexchange.com/questions/tagged/taproot)
...
- Due to [BIP 350](https://github.com/xogecoin/bips/blob/master/bip-0350.mediawiki)
  ...
  (e.g. through [BIP 341](https://github.com/xogecoin/bips/blob/master/bip-0341.mediawiki)).
...
### Documentation
- #21384 add signet to xogecoin.conf documentation (jonatack)
