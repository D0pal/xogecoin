...
#ifndef XOGECOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define XOGECOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@xogecoin.
 *
 ...
 *
 * The chacha20-poly1305@xogecoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@xogecoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@xogecoin are relatively fast in
...
#endif // XOGECOIN_CRYPTO_CHACHA_POLY_AEAD_H
