...
#ifndef XOGECOIN_INTERFACES_CHAIN_H
#define XOGECOIN_INTERFACES_CHAIN_H
...
//! internal workings of the xogecoin node, and not being very convenient to use.
//! Chain methods should be cleaned up and simplified over time. Examples:
//!
//! * The initMessages() and showProgress() methods which the wallet uses to send
//!   notifications to the GUI should go away when GUI and wallet can directly
//!   communicate with each other without going through the node
//!   (https://github.com/xogecoin/xogecoin/pull/15288#discussion_r253321096).
//!
...
//!   node (https://github.com/xogecoin/xogecoin/issues/11756)
class Chain
{
public:
    virtual ~Chain() {}
...
#endif // XOGECOIN_INTERFACES_CHAIN_H
