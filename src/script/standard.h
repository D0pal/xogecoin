...
#ifndef XOGECOIN_SCRIPT_STANDARD_H
#define XOGECOIN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a xogecoin address
 */
...
#endif // XOGECOIN_SCRIPT_STANDARD_H
