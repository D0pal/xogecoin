...
#ifndef XOGECOIN_UTIL_SYSCALL_SANDBOX_H
#define XOGECOIN_UTIL_SYSCALL_SANDBOX_H
...
//!
//! SetupSyscallSandbox(...) is called during xogecoind initialization if Qogecoin Core was compiled
...
#endif // XOGECOIN_UTIL_SYSCALL_SANDBOX_H
