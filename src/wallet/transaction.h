...
#ifndef XOGECOIN_WALLET_TRANSACTION_H
#define XOGECOIN_WALLET_TRANSACTION_H
...
public:
     ...
     * on this xogecoin node, and set to 0 for transactions that were created
...
#endif // XOGECOIN_WALLET_TRANSACTION_H
