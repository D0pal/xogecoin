...
#ifndef XOGECOIN_WALLET_WALLETUTIL_H
#define XOGECOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! xogecoin from opening the wallet, thinking it was newly created, and
...
#endif // XOGECOIN_WALLET_WALLETUTIL_H
