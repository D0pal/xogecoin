...
#ifndef XOGECOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define XOGECOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // XOGECOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
