...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the xogecoin repository."
  exit 1
fi
...
# See https://github.com/xogecoin/xogecoin/issues/16064
...
echo 'When compiling xogecoind, run `./configure` in the following way:'
echo
