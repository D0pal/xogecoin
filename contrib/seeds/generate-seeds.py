...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef XOGECOIN_CHAINPARAMSSEEDS_H\n')
    g.write('#define XOGECOIN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the xogecoin network\n')
    ...
    g.write('#endif // XOGECOIN_CHAINPARAMSSEEDS_H\n')
