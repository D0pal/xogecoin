...
class TestQogecoinCli(QogecoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `xogecoin-cli getblockchaininfo`")
        ...
        self.log.info("Test -getinfo and xogecoin-cli return all proxies")
        ...
        if self.is_specified_wallet_compiled():
            self.log.info("Test -getinfo and xogecoin-cli getwalletinfo return expected wallet info")
            ...
            # Test xogecoin-cli -generate with -rpcwallet in multiwallet mode.
