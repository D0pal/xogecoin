...
""" Tests the utxocache:* tracepoint API interface.
    See https://github.com/xogecoin/xogecoin/blob/master/doc/tracing.md#context-utxocache
"""
...
class UTXOCacheTracepointTest(QogecoinTestFramework):
    ...
    def skip_test_if_missing_module(self):
        ...
        self.skip_if_no_xogecoind_tracepoints()
    ...
    def test_uncache(self):
        ...
        https://github.com/xogecoin/xogecoin/blob/master/doc/tracing.md#tracepoint-utxocacheuncache
        """
        ...
        ctx = USDT(path=str(self.options.xogecoind))
    ...
    def test_add_spent(self):
        """ Tests the utxocache:add utxocache:spent tracepoint API
            See https://github.com/xogecoin/xogecoin/blob/master/doc/tracing.md#tracepoint-utxocacheadd
            and https://github.com/xogecoin/xogecoin/blob/master/doc/tracing.md#tracepoint-utxocachespent
        """
    ...
    def test_flush(self):
        """ Tests the utxocache:flush tracepoint API.
            See https://github.com/xogecoin/xogecoin/blob/master/doc/tracing.md#tracepoint-utxocacheflush"""
