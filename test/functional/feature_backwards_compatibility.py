...
class BackwardsCompatibilityTest(QogecoinTestFramework):
    ...
    def run_test(self):
        ...
        # RPC loadwallet failure causes xogecoind to exit, in addition to the RPC
        ...
        if self.is_bdb_compiled():
            ...
            # Make sure this wallet opens without warnings. See https://github.com/xogecoin/xogecoin/pull/19054
