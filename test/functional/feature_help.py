...
"""Verify that starting xogecoin with -h works as expected."""
...
class HelpTest(QogecoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start xogecoin with -h for help text")
        ...
        self.log.info("Start xogecoin with -version for version information")
        ...
        self.log.info("Start xogecoind with -fakearg to make sure it does not start")
