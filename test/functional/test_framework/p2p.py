...
"""Test objects for interacting with a xogecoind node over the p2p protocol.

The P2PInterface objects interact with the xogecoind nodes under test using the
